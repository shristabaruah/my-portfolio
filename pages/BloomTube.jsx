...
import image from "../public/assets/projects/video-lib.png";
    ...
    <div className="w-full">
      ...
      <div className=" max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8 ">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p className="pb-2">
            BloomTube is an electronics Video Library website on reviews to a
            wide range of electronic products.
          </p>
          <p className="pb-2">
            Features: Playlist Management, Watch later videos, History
            management, Like /Unlike video, Filter video
          </p>
          <button className="px-8 py-2 mr-8">
            <a href="https://bloom-tube.vercel.app/" target="_blank">
              Demo
            </a>
          </button>
          <button className="px-8 py-2">
            <a
              href="https://github.com/shristabaruah/bloomTube"
              target="_blank"
            >
              Code
            </a>
