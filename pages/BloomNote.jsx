...
import image from "../public/assets/projects/noteapp.png";
    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="top-[70%] absolute max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">Bloom Note</h2>
          <h3>Note Taking Web App</h3>
        </div>
      </div>
      ...
      <div className=" max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8 ">
        <div className="col-span-4">
          ...
          <p className="pb-2">
            Features: Authentication , Note Management , Archive / Trash
            Functionality ,Labels Management,Filter notes by Priority and newest
            and oldest,Search Notes by Title as well as description
          </p>
          <button className="px-8 py-2 mr-8">
            <a href="http://bloom-note.vercel.app/" target="_blank">
              Demo
            </a>
          </button>
          <button className="px-8 py-2">
            <a
              href="https://github.com/shristabaruah/BloomNote"
              target="_blank"
            >
              Code
            </a>
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4 ">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 ">
              ...
              <p className=" text-gray-600 py-2 flex items-center ">
                <RiRadioButtonFill className="pr-1" /> Bloom UI
              </p>
              <p className=" text-gray-600 py-2 flex items-center ">
